<template>
  <div class="h-screen flex flex-col dark:bg-gray-900">
    ...
    <div class="flex flex-col">
      ...
      <div class="sticky top-0 z-30 bg-background dark:bg-gray-900 border-b dark:border-gray-700 p-4 sm:p-2 h-14">
      ...
      <!-- Progress Bar (Sticky) -->
      <div class="sticky top-14 z-20 bg-background dark:bg-gray-900 border-b dark:border-gray-700 p-2 h-12">
      ...
      <!-- Director Directing Message (Sticky if active) -->
      <div v-if="directorDirecting" class="sticky top-26 z-10 bg-background dark:bg-gray-900 p-2 h-16">
    ...
    <div class="flex-1 overflow-y-auto container mx-auto p-2 sm:p-4">
      <div class="h-full flex flex-col border rounded-lg bg-background dark:bg-gray-900 dark:border-gray-700">
        <!-- Messages Area -->
        <div ref="messagesContainer" class="flex-1 p-2 sm:p-4 space-y-4">
...
export default {
  ...
  data() {
    return {
      ...
      SOCKET_URL: import.meta.env.VITE_API_URL || 'http://localhost:5001',
  ...
  methods: {
    ...
    connectToSocket() {
      supabase.auth.getSession().then(({ data }) => {
        ...
        { path: "/socket.io",transports: ["polling"],reconnectionAttempts: 5,  secure: true,rejectUnauthorized: false, autoConnect:true,
